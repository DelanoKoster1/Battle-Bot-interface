...
(1, 1, 1, 'INF1A', 'Robot INF1A', '/assets/img/bots/6/Robot_INF1A.png', 'FC:F5:C4:2F:45:5C'),
(2, 2, 2, 'INF1B', 'Robot INF1B', '/assets/img/bots/7/Robot_INF1B.png', 'F0:08:D1:D1:72:A0'),
(3, 3, 3, 'INF1C', 'Robot INF1C', '/assets/img/bots/8/Robot_INF1C.png', '84:CC:A8:7A:A2:A8'),
(4, 4, 4, 'INF1D', 'Robot INF1D', '/assets/img/bots/9/Robot_INF1D.png', '24:0A:C4:61:A6:88'),
(5, 5, 5, 'INF1E', 'Robot INF1E', '/assets/img/bots/10/Robot_INF1E.png', '84:CC:A8:7A:AF:D8');
...
(2, "Test Event", "2022-04-06 13:00:00", "The BattleBot Test Event!", "");

INSERT INTO `team-event` (eventId, teamId) VALUES (1, 1), (1, 2), (1, 3), (1, 4), (1, 5),
                                                  (2, 1), (2, 2), (2, 3), (2, 4), (2, 5);
