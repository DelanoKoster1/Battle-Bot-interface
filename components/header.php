        ...
        <nav class="navbar">
          <ul class="nav w-100 nav-fill">
            ...
            <?php if (!isset($_SESSION['email'])) { ?>
              <li class="nav-item">
                <a class="nav-link text-danger" href="<?= ($_SESSION['sort'] == 'page') ? '../pages/login.php' : 'pages/login.php' ?>">Inloggen / Registeren</a>
              </li>
            <?php } ?>
      ...
      <div class="menu-content">
        <nav role="navigation">
          <ul class="list-unstyled item-list mb-0">
            ...
            <?php if (isset($_SESSION['email']) && $_SESSION['role'] == 2) { ?>
              <li class="menu-item">
                <a href="<?= ($_SESSION['sort'] == 'page') ? '../pages/admin.php' : 'pages/admin.php' ?>">Adminpaneel</a>
              </li>
            <?php } ?>
            <?php if (isset($_SESSION['email'])) { ?>
              <li class="menu-item">
                <a href="<?= ($_SESSION['sort'] == 'page') ? '../pages/logout.php' : 'pages/logout.php' ?>">Uitloggen</a>
              </li>
            <?php } ?>
          </ul>
        </nav>
